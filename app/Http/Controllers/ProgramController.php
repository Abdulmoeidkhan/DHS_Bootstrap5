...
class ProgramController extends Controller
{
    ...
    public function addProgram(Request $req)
    {
        ...
        try {
            ...
            return $savedProgram ? redirect()->route('pages.programs')->with('message', 'Program Added Successfully') : redirect()->route('pages.programs')->with('error', 'Something Went Wrong');
