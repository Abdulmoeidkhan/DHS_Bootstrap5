                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-floating form-floating-outline mb-4">
                                                ...
                                                <label for="basic-default-title">Title</label>
                                            </div>
                                            <div class="form-floating form-floating-outline mb-4">
                                                <input type="text" class="form-control" id="basic-default-description" placeholder="ACME Inc." />
                                                <label for="basic-default-description">Description</label>
                                            </div>
                                            <div class="form-floating form-floating-outline mb-4">
                                                <input class="form-control" type="file" id="logoFile" />
                                                <label for="logoFile" class="form-label">Add Logo Of Event</label>
                                            </div>
                                            <div class="form-floating form-floating-outline mb-4">
                                                <input class="form-control" type="file" id="bannerFile" />
                                                <label for="bannerFile" class="form-label">Add Banner Of Event</label>
                                            </div>
                                            <div class="form-floating form-floating-outline mb-4">
                                                <input type="text" class="form-control" id="date-tag" placeholder="Date Tag" />
                                                <label for="date-tag">Date Tag</label>
                                            </div>
                                            <div class="form-floating form-floating-outline mb-4">
                                            ...
                                            <div class="form-floating form-floating-outline mb-4">
                                                <textarea class="form-control h-px-100" id="Address" placeholder="Comments here..."></textarea>
                                                <label for="Address">Address</label>
                                            </div>
                                            <div class="form-floating form-floating-outline mb-4">
                                                <textarea class="form-control h-px-100" id="googleMaps" placeholder="Comments here..."></textarea>
                                                <label for="googleMaps">Google Maps</label>
                                            </div>
                                            <div class="form-floating form-floating-outline mb-4">
                                                <select class="form-select h-px-100" id="organiserSelect" aria-label="Multiple select example">
                                                    <option selected>Open this select menu</option>
                                                    <option value="1">One</option>
                                                    <option value="2">Two</option>
                                                    <option value="3">Three</option>
                                                </select>
                                                <label for="organiserSelect">Organiser Select</label>
                                            </div>
                                            <div class="col-md p-4">
                                                <small class="text-light fw-semibold">Status</small>
                                                <div class="form-check mt-3">
                                                    <input name="status" class="form-check-input" type="radio" value="" id="ActiveEve" checked/>
                                                    <label class="form-check-label" for="ActiveEve"> Active </label>
                                                </div>
                                                <div class="form-check form-check-danger">
                                                    <input name="status" class="form-check-input" type="radio" value="" id="InActiveEve"  />
                                                    <label class="form-check-label" for="InActiveEve"> InActive </label>
                                                </div>
                                            </div>
                                            <button type="submit" name="eventAdd" class="btn btn-primary">Add Event</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
