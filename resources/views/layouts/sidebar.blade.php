            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('pages.selfRepDetailReport')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
                                <span class="hide-menu">Self/Rep Detail</span>
                            </a>
                        </li>
                        <!-- <li class="sidebar-item">
                            <a href="../main/blog-detail.html" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('pages.hotelCheckInDetails')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('pages.delegationCheckOutStatus')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('pages.delegationCheckOutStatusVIPReport')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('pages.hotelCheckOutDetails')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item">
                            <a href="{{route('pages.officerLOReport')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('pages.officerROReport')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('pages.officerIOReport')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-grain"></i>
                                </div>
