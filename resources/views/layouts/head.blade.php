...
<?php $routesIncludedTable = array('pages.delegationsPage', 'pages.members', 'pages.liasons', 'pages.liasonSpecificProfile', 'pages.renderSpecificLiason', 'pages.liasonDelegateProfile', 'pages.flights', 'pages.cars', 'pages.category', 'pages.addPlan', 'pages.programs', 'pages.interpreters', 'pages.receivings', 'pages.officer', 'pages.delegatesPage', 'pages.airport', 'pages.badges', 'pages.hotels', 'pages.listOfAllDelegation', 'pages.listOfAllDelegates', 'pages.delegationAttendance', 'pages.countryReport', 'pages.vipDelegationReport', 'pages.countryAndVipReport', 'pages.selfRepReport', 'pages.delegationArrivalStatusReport', 'pages.wishPage', 'pages.feedbackPage', 'pages.delegationArrivalStatusVIPReport', 'pages.delegationArrivalDetailReport', 'pages.delegationDepartureDetailReport','pages.delegationDepartureStatusReport','pages.delegationDepartureStatusVIPReport','pages.delegationCheckInStatus','pages.delegationCheckInStatusVIPReport'); ?>
