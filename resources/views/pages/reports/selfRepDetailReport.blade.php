                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-filter-control="input" data-field="count" data-sortable="true"
                                data-fixed-columns="true" data-formatter="operateText">Invitation</th>
                            <th data-filter-control="input" data-field="selfSum" data-sortable="true"
                                data-fixed-columns="true" data-formatter="operateNumber">Accepted Self</th>
                            <th data-filter-control="input" data-field="selfCountries" data-sortable="true"
                                data-fixed-columns="true" data-formatter="operateCountries">Accepted Self Countries</th>
                            <th data-filter-control="input" data-field="repSum" data-sortable="true"
                                data-fixed-columns="true" data-formatter="operateNumber">Accepted Rep</th>
                            <th data-filter-control="input" data-field="repCountries" data-sortable="true"
                                data-fixed-columns="true" data-formatter="operateCountries">Accepted Rep Countries</th>
                            ...
                            <th data-filter-control="input" data-field="regrettedCountries" data-sortable="true"
                                data-fixed-columns="true" data-formatter="operateCountries">Regretted Countries</th>
                            <th data-filter-control="input" data-field="totalCountOfDelegatesSum" data-sortable="true"
                                data-fixed-columns="true" data-formatter="operateNumber">Number Of Delegates</th>
