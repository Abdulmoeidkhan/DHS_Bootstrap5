    ...
    <div class="card w-100">
        <div class="card-body p-4">
            ...
            <div id="Used" class="tabcontent">
                <p>
                <div class="table-responsive">
                    <table id="table2" data-filter-control-multiple-search="true" data-height="999" data-filter-control-multiple-search-delimiter="," data-virtual-scroll="true" data-filter-control="true" data-toggle="table2" data-flat="true" table id="table" data-filter-control-multiple-search="true" data-height="999" data-filter-control-multiple-search-delimiter="," data-pagination="true" data-show-toggle="true" data-show-export="true" data-show-columns="true" data-show-refresh="true" data-show-pagination-switch="true" data-show-columns-toggle-all="true" data-page-list="[10, 25, 50, 100, all]" data-url="{{route('request.getDelegationFlight',2)}}">
                        <thead>
                            <tr>
                                <th data-filter-control="input" data-field="Serial Number" data-formatter="operateSerial">S.No</th>
                                <th data-filter-control="input" data-field="country.country" data-sortable="true" data-formatter="operateText">Country</th>
            ...
            <div id="All" class="tabcontent" style="display: block;">
                <p>
                <div class="table-responsive">
                    <table id="table3" data-filter-control-multiple-search="true" data-height="999" data-filter-control-multiple-search-delimiter="," data-virtual-scroll="true" data-filter-control="true" data-toggle="table3" data-flat="true" table id="table" data-filter-control-multiple-search="true" data-height="999" data-filter-control-multiple-search-delimiter="," data-pagination="true" data-show-toggle="true" data-show-export="true" data-show-columns="true" data-show-refresh="true" data-show-pagination-switch="true" data-show-columns-toggle-all="true" data-page-list="[10, 25, 50, 100, all]" data-url="{{route('request.getDelegationFlight',3)}}">
                        <thead>
                            <tr>
                                <th data-filter-control="input" data-field="Serial Number" data-formatter="operateSerial">S.No</th>
                                <th data-filter-control="input" data-field="country.country" data-sortable="true" data-formatter="operateText">Country</th>
...
<script>
    ...
    //         return [
    //             '<div class="left">',
    //             '<a class="btn btn-success" href="viewItinerary/' + value + '">',
    ...
    //         return [
    //             '<div class="left">',
    //             '<a class="btn btn-success" href="viewPassenger/' + value + '">',
    ...
    function operateArrivalStatusChanger(value, row, index) {
        if (value == 1) {
            return [
                '<div class="left">',
                '<a class="btn btn-badar" href="arrivalStatusChanger/' + row.delegate_uid + '/0">',
                '<span><i class="ti ti-plane-arrival" style="font-size:22px"></i></span>',
                '</a>',
                '</div>',
            ].join('');
        } else {
            return [
                '<div class="left">',
                '<a class="btn btn-success" href="arrivalStatusChanger/' + row.delegate_uid + '/1">',
                '<span><i class="ti ti-plane-arrival" style="font-size:22px"></i></span>',
                '</a>',
                '</div>',
            ].join('');
    ...
    function operateDepartureStatusChanger(value, row, index) {
        if (value == 1) {
            return [
                '<div class="left">',
                '<a class="btn btn-badar" href="departureStatusChanger/' + row.delegate_uid + '/0">',
                '<span><i class="ti ti-plane-departure" style="font-size:22px"></i></span>',
                '</a>',
                '</div>',
            ].join('');
        } else {
            return [
                '<div class="left">',
                '<a class="btn btn-success" href="departureStatusChanger/' + row.delegate_uid + '/1">',
                '<span><i class="ti ti-plane-departure" style="font-size:22px"></i></span>',
                '</a>',
                '</div>',
            ].join('');
